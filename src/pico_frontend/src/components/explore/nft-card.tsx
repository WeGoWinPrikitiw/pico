...
import { isNewNFT, formatOwnerAddress } from "@/lib/nft-utils";
import { Heart, Share2, Sparkles, Eye, TrendingUp } from "lucide-react";
          ...
          <div className="p-4 flex flex-col flex-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground font-medium">
                <UserName principalId={nft.owner} maxLength={10} />
              </span>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      <UserName principalId={nft.owner} maxLength={12} />
                    </span>
                  </div>
                </div>
