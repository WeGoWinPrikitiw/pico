            ...
            <div className="flex flex-col space-y-6">
              ...
              <div>
                ...
                <div className="mt-4 flex items-center gap-6 text-sm text-muted-foreground">
                  <div className="flex items-center gap-2">
                    <UserAvatar principalId={nft.owner} size="md" />
                    <div>
                      <span className="text-xs">Owner</span>
                      <p className="font-semibold text-foreground">
                        <UserName
                          principalId={nft.owner}
                  ...
                  <div className="py-4 space-y-4">
                    ...
                    <div className="flex justify-between items-center text-sm font-semibold">
                      ...
                      <span className="text-primary">
                        {Number(nft.price) + 1} PiCO
                      </span>
                    </div>
                    <div className="p-3 bg-muted rounded-lg text-xs text-muted-foreground">
                      <p>
                        This approval allows the contract to spend up to{" "}
                        {Number(nft.price) + 1} PiCO tokens from your wallet.
                        The extra 1 PiCO buffer ensures successful transactions.
                      </p>
                    </div>
                  </div>
                  <DialogFooter>
