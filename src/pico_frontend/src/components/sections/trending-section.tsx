...
const mockTrendingData: TrendingItem[] = [
    {
        ...
        imageUrl: "https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=300&h=400&fit=crop",
    ...
    },
    {
        ...
        title: "Title",
        description: "Please add your content here. Keep it short and simple. And smile :)",
        imageUrl: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=350&h=400&fit=crop",
        profileImage: "https://images.unsplash.com/photo-1494790108755-2616b612b789?w=40&h=40&fit=crop&crop=face",
        likes: 67,
        comments: 12,
        shares: 9,
        width: 350
    },
    {
        ...
        title: "Title",
        description: "Please add your content here. Keep it short and simple. And smile :)",
        imageUrl: "https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=280&h=400&fit=crop",
    ...
    },
    {
        ...
        title: "Title",
        description: "Please add your content here. Keep it short and simple. And smile :)",
        imageUrl: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=320&h=400&fit=crop",
    ...
    },
    {
        ...
        title: "Title",
        description: "Please add your content here. Keep it short and simple. And smile :)",
        imageUrl: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=270&h=400&fit=crop",
            ...
            <div className="relative w-full">
                ...
                <div className="mb-6 lg:mb-8">
                    ...
                    >
                        ...
                        {[...topRowData, ...topRowData, ...topRowData].map((item, index) => (
                            <div key={`top-${index}`} className="flex-shrink-0 mr-6 lg:mr-8">
                ...
                <div>
                    ...
                    >
                        {/* Duplicate items for seamless loop */}
                        {[...bottomRowData, ...bottomRowData, ...bottomRowData].map((item, index) => (
                            <div key={`bottom-${index}`} className="flex-shrink-0 mr-6 lg:mr-8">
                                <TrendingCard item={item} />
                            </div>
                        ))}
                    </div>
