...
export function ForumsPage() {
  ...
  const { data: userForums = [], isLoading: isLoadingUserForums } =
  ...
  const isLoading =
    activeFilter === "my-forums" ? isLoadingUserForums : isLoadingAll;
        ...
        <div className="max-w-lg space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Connect your wallet to participate in community conversations,
              create engaging topics, and connect with fellow NFT enthusiasts.
            </p>
          </div>
      ...
      <div className="flex h-screen flex-col items-center justify-center gap-6 p-6">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground max-w-md">
            We encountered an issue while fetching the community forums. Please
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-xl text-muted-foreground">
                Discover insights, share ideas, and connect with the PiCO
                community
              </p>
            </div>
              ...
              <CardHeader className="pb-4">
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                  ...
                  <div className="flex items-center gap-1 p-1 bg-muted rounded-lg">
                    ...
                    <Button
                      variant={
                        activeFilter === "my-forums" ? "default" : "ghost"
                      }
                      size="sm"
                ...
                {isLoading ? (
                  ...
                  <div className="space-y-0">
                    {forumsToDisplay.map((forum, index) => (
                      <Link to={`/forums/${forum.forum_id}`}>
                        <div
                          key={String(forum.forum_id)}
                          className={`group p-6 hover:bg-muted/30 rounded-xl transition-all duration-200 ${
                            index !== forumsToDisplay.length - 1
                              ? "border-b"
                              : ""
                          }`}
                        >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-4">
                                <div className="flex-1 min-w-0">
                                  ...
                                  <p className="text-muted-foreground leading-relaxed line-clamp-2 mb-3"></p>
