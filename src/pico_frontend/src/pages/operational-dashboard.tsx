...
export function OperationalDashboard() {
    ...
    const stats = [
        ...
        {
            title: 'Total Supply',
            value: tokenInfo?.totalSupply ? (Number(tokenInfo.totalSupply) / 100000000).toLocaleString() : '0',
            icon: TrendingUp,
            change: '+8.2%',
            changeType: 'positive' as const,
                    ...
                    <Card className="mb-8 border-0 shadow-xl bg-card/50 backdrop-blur-sm">
                        <CardContent className="p-6">
                            <div className="flex justify-between items-start">
                                ...
                                <Button onClick={logout} variant="outline" className="border-destructive/20 text-destructive hover:bg-destructive hover:text-destructive-foreground">
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h3 className="font-medium text-blue-900 dark:text-blue-100">Principal ID</h3>
                                                <p className="text-sm font-mono text-blue-700 dark:text-blue-300 truncate">{principal}</p>
                                            </div>
                                            <Button size="sm" variant="outline" onClick={copyPrincipalToClipboard} className="border-blue-200 hover:bg-blue-100">
                                ...
                                <Card className="border-0 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/50 dark:to-green-900/50">
                                    <CardContent className="p-6">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="font-medium text-green-900 dark:text-green-100">PiCO Balance</h3>
                                                <p className="text-2xl font-bold text-green-700 dark:text-green-300">{userBalance}</p>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="border-0 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/50 dark:to-purple-900/50">
                                    <CardContent className="p-6">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="font-medium text-purple-900 dark:text-purple-100">Token Info</h3>
                                                {tokenInfo ? (
                            ...
                            <div className="mt-6 flex justify-end">
                                <Button onClick={refreshData} disabled={loading} variant="outline" className="shadow-sm">
                    ...
                    <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="space-y-6">
                        <div className="bg-card/50 backdrop-blur-sm rounded-xl p-2 shadow-lg border-0">
                            <TabsList className="w-full justify-start bg-transparent p-0 h-auto space-x-2">
                                <TabsTrigger value="overview" className="flex items-center gap-2 px-6 py-3 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-medium">
                                    <Wallet className="h-4 w-4" />
                                    Overview
                                </TabsTrigger>
                                <TabsTrigger value="nft" className="flex items-center gap-2 px-6 py-3 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-medium">
                                    <ShoppingCart className="h-4 w-4" />
                                    NFT Operations
                                </TabsTrigger>
                                <TabsTrigger value="admin" className="flex items-center gap-2 px-6 py-3 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-medium">
                                    <CreditCard className="h-4 w-4" />
                                    Admin Functions
                                </TabsTrigger>
                                <TabsTrigger value="transactions" className="flex items-center gap-2 px-6 py-3 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-medium">
                        ...
                        <TabsContent value="overview" className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                {stats.map((stat) => (
                                    <Card key={stat.title} className="border-0 shadow-lg bg-card/50 backdrop-blur-sm hover:shadow-xl transition-all duration-200">
                                        <CardContent className="p-6">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
                                        ...
                                        <CardContent className="space-y-3">
                                            <Button variant="outline" className="w-full justify-between group hover:bg-primary hover:text-primary-foreground transition-colors">
                                    ...
                                    <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <Badge variant="outline" className="text-yellow-600 border-yellow-200">Maintenance</Badge>
                                            </div>
                                        </CardContent>
                                    </Card>
                                </div>
                        ...
                        <TabsContent value="nft" className="space-y-6">
                            <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
                                <CardHeader>
                                    ...
                                    <p className="text-muted-foreground">Execute NFT transactions on the marketplace</p>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium">Buyer Principal ID</label>
                                            <Input
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium">Seller Principal ID</label>
                                            <Input
                                    ...
                                    <Button onClick={handleBuyNFT} disabled={loading} className="w-full h-12 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg">
                                        {loading ? (
                                            <LoadingSpinner size="sm" className="mr-2" />
                                        ) : (
                                            <ShoppingCart className="h-4 w-4 mr-2" />
                        ...
                        <TabsContent value="admin" className="space-y-6">
                            <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
                                <CardHeader>
                                    ...
                                    <p className="text-muted-foreground">Administrative function to mint new tokens</p>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                    ...
                                    <Button onClick={handleMintTokens} disabled={loading} className="w-full h-12 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-600 text-white shadow-lg">
                                        {loading ? (
                                            <LoadingSpinner size="sm" className="mr-2" />
                                        ) : (
                            ...
                            <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
                                <CardHeader>
                                    ...
                                    <p className="text-muted-foreground">Add tokens to your own account</p>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="space-y-2">
                                    ...
                                    <Button onClick={handleSelfTopUp} disabled={loading} className="w-full h-12 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white shadow-lg">
                                        {loading ? (
                                            <LoadingSpinner size="sm" className="mr-2" />
                                        ) : (
                            ...
                            <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
                                <CardHeader>
                                    ...
                                    <p className="text-muted-foreground">Check the token balance of any principal</p>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="space-y-2">
                                    ...
                                    <Button onClick={handleCheckBalance} disabled={loading} variant="outline" className="w-full h-12 border-primary/20 hover:bg-primary hover:text-primary-foreground">
                                        {loading ? (
                                            <LoadingSpinner size="sm" className="mr-2" />
                                        ) : (
                        ...
                        <TabsContent value="transactions">
                            <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
                                <CardHeader>
                                    ...
                                    <p className="text-muted-foreground">Complete history of your transactions</p>
                                </CardHeader>
                                <CardContent>
                                    {transactions.length > 0 ? (
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <h3 className="font-medium text-muted-foreground mb-2">No transactions found</h3>
                                            <p className="text-sm text-muted-foreground">Your transaction history will appear here once you start making transactions</p>
                                        </div>
                                    )}
                                </CardContent>
                            </Card>
