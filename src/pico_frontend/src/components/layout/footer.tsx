        ...
        < footer className="bg-[#CE0AFF] text-white" >
            <div className="max-w-7xl mx-auto px-8 py-12">
                ...
                <div className="flex justify-between items-start">
                    <div className="flex items-center gap-3">
                        <img src="/brand/pico-logo-dark.svg" alt="PICO" className="w-[200px]" />
                    </div>
                </div>

                {/* Main heading */}
                <div className="mb-16">
                    <h1 className={`text-2xl md:text-3xl font-bold leading-tight font-lexend`}>
                ...
                <div className="flex flex-col md:grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                        {/* Navigation */}
                        <div>
                            <h3 className={`text-lg font-bold mb-4 font-lexend`}>Navigation</h3>
                        ...
                        <div>
                            <h3 className={`text-lg font-bold mb-4 font-lexend`}>Social media</h3>
                            <ul className="space-y-2 text-sm">
                                <li>
                                    <a href="#" className="hover:text-gray-300 transition-colors">
                                        Twitter
            ...
            <div className="bg-gray-100 py-4">
                <div className="max-w-7xl mx-auto px-8">
                    <p className="text-center text-gray-600 text-sm">© 2025 PICO. All rights reserved.</p>
                </div>
            </div>
        </footer >
    )
