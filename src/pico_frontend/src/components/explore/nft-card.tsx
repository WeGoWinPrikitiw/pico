...
export function NFTCard({ nft, variant = "grid", onLike, onShare }: NFTCardProps) {
    const stats = getNFTStats(nft.nft_id);
    ...
    if (variant === "list") {
        return <NFTListCard nft={nft} stats={stats} isNew={isNew} onLike={handleLike} onShare={handleShare} />;
    }

    return <NFTGridCard nft={nft} stats={stats} isNew={isNew} onLike={handleLike} onShare={handleShare} />;
}

interface NFTCardInternalProps {
    nft: FrontendNFTInfo;
    stats: ReturnType<typeof getNFTStats>;
    isNew: boolean;
    onLike: (e: React.MouseEvent) => void;
    onShare: (e: React.MouseEvent) => void;
}

function NFTGridCard({ nft, stats, isNew, onLike, onShare }: NFTCardInternalProps) {
    return (
...
function NFTListCard({ nft, stats, isNew, onLike, onShare }: NFTCardInternalProps) {
    return (
        <Link to={`/nft/${nft.nft_id}`} className="block">
