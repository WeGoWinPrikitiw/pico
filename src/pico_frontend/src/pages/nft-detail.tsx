                                ...
                                <CardContent>
                                    <div className="flex items-center justify-between mb-4">
                                        <div>
                                            ...
                                            <p className="text-3xl font-bold text-primary">{(nft.price / 1e8).toFixed(2)} PiCO</p>
                                        </div>
                                        {isAuthenticated && (
                                ...
                                <DialogContent className="sm:max-w-[425px]">
                                    ...
                                    <div className="py-4 space-y-4">
                                        <div className="flex justify-between items-center text-sm">
                                            ...
                                            <span className="font-medium">{(nft.price / 1e8).toFixed(2)} PiCO</span>
                                        </div>
                                        <div className="flex justify-between items-center text-sm">
                                        ...
                                        <div className="flex justify-between items-center text-sm font-semibold">
                                            ...
                                            <span className="text-primary">{((nft.price + 1e6) / 1e8).toFixed(2)} PiCO</span>
                                        </div>
                                        <div className="p-3 bg-muted rounded-lg text-xs text-muted-foreground">
                                            <p>This approval allows the contract to spend up to {((nft.price + 1e6) / 1e8).toFixed(2)} PiCO tokens from your wallet. The extra 0.01 PiCO buffer ensures successful transactions.</p>
                                        </div>
                                    </div>
                                    <DialogFooter>
